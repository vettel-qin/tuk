...
import { addPageMember } from '@/services/api/pageMember'
/**
 * 成员管理
 */
...
const MemberSetting = (props: any, ref: any) => {
  ...
  const pageId = usePageInfoStore().page.id
  ...
  const handleOk = async () => {
    ...
    try {
      ...
      await addPageMember({
        type,
        pageId: type == 1 ? parseInt(projectId) : pageId,
        role,
        userName,
      })
